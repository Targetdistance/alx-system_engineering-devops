...
Project done during **Full Stack Software Engineering studies** at **ALX School Africa**. It aims to learn about loops (`while`, `until` and `for`), condition statements (`if`, `else`, `elif` and `case`), shebangs and how to create SSH keys with **Bash**.
